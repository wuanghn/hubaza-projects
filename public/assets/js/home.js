    ...
    function get_new(skip){
        ...
        $.get( "contents", {
            ...
            for(i=0; i< data2['contents'].length; i++){
               ...
               html +=' <h3>';
               html +=' <a href="'+url+'/posts/'+data2['contents'][i]['slug']+'">'+data2['contents'][i]['title']+'</a>';
               html +=' </h3>';
               html +=' <p class="lead">';
               ...
               html +=' <a class="btn btn-social btn-facebook" href="https://www.facebook.com/dialog/feed?app_id=828149473934812&display=popup&caption= '+data2['contents'][i]['title']+'&link='+url+'/posts/'+data2['contents'][i]['slug']+'&redirect_uri='+url+'/post/home">';
